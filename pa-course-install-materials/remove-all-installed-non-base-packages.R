  ...
  proceed.answer = readInput(question="This script should only be run if you are having major with R and or other packages being updated/installed on your machine. Is this your issue?")
  ...
  cat(paste("We will now install every non-base or non-recommended package for an R installation from your machine.",
            "If this is not your intention press goto the Session menu and try and interrupt or terminate R.",sep="\n"))
